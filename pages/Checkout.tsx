...
const Checkout = () => {
  const { cart, settings, addOrder, coupons, updateCartQuantity, removeFromCart, trackWithEmailAndPhone } = useStore();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/order-success', { state: { order: { ...order, id: orderId, createdAt: Date.now() } } });
    } catch (err) {
