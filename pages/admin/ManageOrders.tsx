...
const handleDownloadInvoice = (order: Order, settings?: any) => {
    const origin = getBaseAppUrl(settings);
    const appName = settings?.appName || 'Baby Boutique';
            ...
            <tr>
                <td style="vertical-align: middle; width: 60%;">
                    ...
                    <div style="font-size: 11px; color: #64748b; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin-top: 2px;">
                        Luxury Baby Boutique & Kids Apparel
                    </div>
                </td>
...
const ManageOrders = () => {
    ...
    const { myOrders: orders, updateOrderStatus, deleteOrder, isLoading, settings } = useStore();
                    ...
                    <div key={order.id} className="bg-white rounded-lg shadow-sm p-3 space-y-2 text-sm">
                        ...
                        <div className="flex justify-between items-center border-t pt-2">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                <Button variant="ghost" size="sm" onClick={() => handleDownloadInvoice(order, settings)} title="Download Invoice"><Icons.download className="w-5 h-5"/></Button>
                            ...
                            <tr key={order.id} className="hover:bg-gray-50 text-sm">
                                ...
                                <td className="p-3 whitespace-nowrap">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <button onClick={() => handleDownloadInvoice(order, settings)} className="text-gray-600 hover:text-gray-800" title="Download Invoice"><Icons.download className="w-5 h-5"/></button>
